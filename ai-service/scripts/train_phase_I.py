...
def create_training_components(device: torch.device):
    model = create_efficientnet_b0(class_count=CLASS_COUNT, freeze_backbone=True)
...
def main():
    ...
    run_name = (
        "efficientnet_b0_phase1_dry_run"
        if DRY_RUN
        else "efficientnet_b0_phase1"
    )
    ...
    print("AutoSpot phase 1 training")
